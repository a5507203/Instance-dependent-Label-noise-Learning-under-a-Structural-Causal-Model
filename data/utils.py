...
def noisify(dataset='mnist', nb_classes=10, train_labels=None, noise_type=None, noise_rate=0, random_state=0):
    ...
    if noise_type == 'symmetric':
        ...
        noisy_labels = torch.load('./CIFAR-N/CIFAR-10_human.pt') 
        train_noisy_labels = noisy_labels[noise_type]
        actual_noise_rate = (train_noisy_labels != train_labels).mean()
    elif noise_type == 'noisy_label':
        noisy_labels = torch.load('./CIFAR-N/CIFAR-100_human.pt') 
        train_noisy_labels = noisy_labels[noise_type]
        actual_noise_rate = (train_noisy_labels != train_labels).mean()
