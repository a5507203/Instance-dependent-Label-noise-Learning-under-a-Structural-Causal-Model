...
from .torchvisiondatasetsutils import check_integrity, download_and_extract_archive
import torch


__all__ =["CIFAR10_noise","CIFAR100_noise"]


class CIFAR10_noise(VisionDataset):
    ...
    def __init__(
        ...
        super(CIFAR10_noise, self).__init__(root, transform=transform,
...
class CIFAR100_noise(CIFAR10_noise):
