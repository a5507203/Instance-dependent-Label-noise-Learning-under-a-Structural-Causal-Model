...
class CONV_Encoder_FMNIST(nn.Module):
    def __init__(self, in_channels =1, feature_dim = 28, num_classes = 2,  hidden_dims = [32, 64, 128, 256], z_dim = 2, lambda_dim=1):
        super().__init__()
        self.z_dim = z_dim
...
class CONV_Encoder_CIFAR(nn.Module):
    def __init__(self, in_channels =3, feature_dim = 32, num_classes = 2,  hidden_dims = [32, 64, 128, 256], z_dim = 2, lambda_dim=1):
        super().__init__()
        self.z_dim = z_dim
        self.feature_dim = feature_dim
        self.embed_class = nn.Linear(num_classes, feature_dim * feature_dim)
...
class CONV_Encoder_CLOTH1M(nn.Module):
    def __init__(self, in_channels =3, feature_dim = 224, num_classes = 2,  hidden_dims = [32, 64, 128, 256, 512], z_dim = 2, lambda_dim=1):
        super().__init__()
        self.z_dim = z_dim
        self.feature_dim = feature_dim
        self.embed_class = nn.Linear(num_classes, feature_dim * feature_dim)
...
class CONV_Encoder_WEBVISION(nn.Module):
    def __init__(self, in_channels =3, feature_dim = 299, num_classes = 2,  hidden_dims = [32, 64, 128, 256, 512], z_dim = 2, lambda_dim=1):
        super().__init__()
        self.z_dim = z_dim
        self.feature_dim = feature_dim
        self.embed_class = nn.Linear(num_classes, feature_dim * feature_dim)
        ...
        self.encoder = nn.Sequential(*modules)
        self.fc_mu = nn.Linear(hidden_dims[-1]*36, z_dim)
        self.fc_logvar = nn.Linear(hidden_dims[-1]*36, z_dim)
...
class CONV_T_Decoder_WEBVISION(nn.Module):
    def __init__(self, in_channels =3, feature_dim = 299, num_classes = 50,  hidden_dims = [32, 64, 128, 256, 512]):
        super().__init__()
        ...
        self.encoder = nn.Sequential(*modules)
        self.fc = nn.Linear(hidden_dims[-1]*36, num_classes)
...
class Z_Encoder(nn.Module):
    def __init__(self, feature_dim = 2, num_classes = 2, num_hidden_layers=1, hidden_size = 5, z_dim = 2, lambda_dim=1):
        super().__init__()
